...
- Fully compatible with **NGINX Proxy Manager** or standard NGINX.
...
Replace YOUR_IPINFO_TOKEN with the token from your account.

Place the downloaded file at /opt/ipclem/ipinfo_lite.mmdb or update app.py accordingly.
...
pip install ipinfo
Make sure the IPinfo Lite MMDB is placed at /opt/ipclem/ipinfo_lite.mmdb.
...
Contact
Created and maintained by Coby Godfrey.
